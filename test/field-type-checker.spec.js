...
describe('xcraft.converters.field-type', function () {
  it('field-type string', function () {
    let result;
  ...
  it('field-type percent', function () {
    let result;
  ...
  it('field-type entityId', function () {
    let result;
