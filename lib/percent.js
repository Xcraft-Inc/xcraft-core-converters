...
function parseEdited(editedPercent, minCanonical, maxCanonical) {
  ...
  if (minCanonical !== undefined && canonical < minCanonical) {
    return {value: getDisplayed(minCanonical), error: T('Valeur trop petite')};
  }
  if (maxCanonical !== undefined && canonical > maxCanonical) {
    return {value: getDisplayed(maxCanonical), error: T('Valeur trop grande')};
  }
