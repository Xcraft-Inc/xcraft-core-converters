...
function parseEdited(editedPrice, minCanonical, maxCanonical) {
  ...
  if (minCanonical !== undefined && x < minCanonical) {
    return {value: getDisplayed(minCanonical), error: T('Prix trop bas')};
  }
  if (maxCanonical !== undefined && x > maxCanonical) {
    return {value: getDisplayed(maxCanonical), error: T('Prix trop élévé')};
  }
