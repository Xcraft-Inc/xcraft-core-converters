...
// With '2017-03-31T12:48:000.000Z', return {year: 2017, month: 03, day: 31, hours: 14, minutes: 48, seconds: 00}.
// With '2019-05-11T15:33:50.27+02:00', return {year: 2019, month: 05, day: 11, hours: 13, minutes: 33, seconds: 50}.
...
function split(canonicalDateTime, locale = false) {
  ...
  if (
    ...
    throw new Error(
      `Bad canonical datetime '${canonicalDateTime}' (must be 'yyyy-mm-ddThh:mm:ss.000Z' or 'yyyy-mm-ddThh:mm:ss.nnn+xx:yy') where n >= 3`
    );
  }
...
// With date = '2019-05-11T15:33:50.27+02:00', return '11.05.2019 13:33'.
...
// With date = '2017-03-31T12:48:00.000Z', return '31.03.2017 14:48'.
// With date = '2019-05-11T15:33:50.27+02:00', return '11.05.2019 15:33'.
...
function getDisplayedDelta(datetime1, datetime2) {
  if (!datetime2) {
