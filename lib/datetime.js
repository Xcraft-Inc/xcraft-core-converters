...
function split(canonicalDateTime, locale = false) {
  ...
  if (
    ...
    throw new Error(
      `Bad canonical datetime '${canonicalDateTime}' (must be 'yyyy-mm-ddThh:mm:ss.000Z' or 'yyyy-mm-ddThh:mm:ss.nn+xx:yy') where n >= 2`
    );
  }
