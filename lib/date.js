...
function parseEdited (
  ...
  console.log (
    `parseEdited: editedDate=${editedDate} defaultCanonicalDate=${defaultCanonicalDate} minCanonicalDate=${minCanonicalDate} maxCanonicalDate=${maxCanonicalDate}`
  );
