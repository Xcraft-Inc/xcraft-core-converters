...
const shortUpperMonths = [
  T('month|short|upper|Jan', shortUpperMonthsDescription),
  T('month|short|upper|Fév', shortUpperMonthsDescription),
  T('month|short|upper|Mars', shortUpperMonthsDescription),
  T('month|short|upper|Avr', shortUpperMonthsDescription),
  T('month|short|upper|Mai', shortUpperMonthsDescription),
  T('month|short|upper|Juin', shortUpperMonthsDescription),
  T('month|short|upper|Juil', shortUpperMonthsDescription),
  T('month|short|upper|Août', shortUpperMonthsDescription),
  T('month|short|upper|Sept', shortUpperMonthsDescription),
  T('month|short|upper|Oct', shortUpperMonthsDescription),
  T('month|short|upper|Nov', shortUpperMonthsDescription),
  T('month|short|upper|Déc', shortUpperMonthsDescription),
];
...
const longUpperMonths = [
  T('month|long|upper|Janvier', longUpperMonthsDescription),
  T('month|long|upper|Février', longUpperMonthsDescription),
  T('month|long|upper|Mars', longUpperMonthsDescription),
  T('month|long|upper|Avril', longUpperMonthsDescription),
  T('month|long|upper|Mai', longUpperMonthsDescription),
  T('month|long|upper|Juin', longUpperMonthsDescription),
  T('month|long|upper|Juillet', longUpperMonthsDescription),
  T('month|long|upper|Août', longUpperMonthsDescription),
  T('month|long|upper|Septembre', longUpperMonthsDescription),
  T('month|long|upper|Octobre', longUpperMonthsDescription),
  T('month|long|upper|Novembre', longUpperMonthsDescription),
  T('month|long|upper|Décembre', longUpperMonthsDescription),
];
...
const shortUpperDows = [
  T('dow|short|upper|Lun', shortUpperDowsDescription),
  T('dow|short|upper|Mar', shortUpperDowsDescription),
  T('dow|short|upper|Mer', shortUpperDowsDescription),
  T('dow|short|upper|Jeu', shortUpperDowsDescription),
  T('dow|short|upper|Ven', shortUpperDowsDescription),
  T('dow|short|upper|Sam', shortUpperDowsDescription),
  T('dow|short|upper|Dim', shortUpperDowsDescription),
];
...
const longUpperDows = [
  T('dow|long|upper|Lundi', longUpperDowsDescription),
  T('dow|long|upper|Mardi', longUpperDowsDescription),
  T('dow|long|upper|Mercredi', longUpperDowsDescription),
  T('dow|long|upper|Jeudi', longUpperDowsDescription),
  T('dow|long|upper|Vendredi', longUpperDowsDescription),
  T('dow|long|upper|Samedi', longUpperDowsDescription),
  T('dow|long|upper|Dimanche', longUpperDowsDescription),
];
...
function parseEdited(
  ...
  if (date.day < 1 || date.day > 31) {
    ...
    if (mode === 'hard') {
      ...
      error = `Minimum conseillé: ${getDisplayed(minCanonicalDate)}`;
    }
    ...
    if (mode === 'hard') {
      ...
      // Accept a date out of range, but reports a warning.
      error = `Maximum conseillé: ${getDisplayed(maxCanonicalDate)}`;
    }
  } else {
    if (date.day !== r.day) {
      incorrectDay = true;
