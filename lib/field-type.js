...
const DateTimeConverters = datetime;
const PriceConverters = price;
const WeightConverters = weight;
const LengthConverters = length;
const VolumeConverters = volume;
const NumberConverters = number;
const PercentConverters = percent;
const DelayConverters = delay;
